...
### 15. Не смог найти внятную ошибку в dashboard истории действий, во время которой происходила моя ddos атака из-за большой истории действий. На картинке ниже нашел одну из нескольких ошибкок с большим уровням атаки для пирмера. 
